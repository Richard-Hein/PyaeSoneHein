...
const AboutMe = () => {
  return (
    <section className="pt-[25px] bg-base max-w-[800px]  mx-auto">
      ...
      <div className="grid ms-0 md:ms-6  md:grid-cols-2 md:gap-2  relative  mb-[1.5rem]  md:px-4 md:py-2">
        ...
        <div className="  mt-6 px-2 ">
          <p className="text-justify max-w-xl indent-8">
            I'm a <b className="text-primary">self-taught developer </b> with a strong passionfor building
